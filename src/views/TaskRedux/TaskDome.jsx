...
const TaskHooks = function (props) {
  const {taskList, getTaskList, delTaskList, updateTaskState} = props
...
export default connect(state => state.task, actions.task)(TaskHooks)
